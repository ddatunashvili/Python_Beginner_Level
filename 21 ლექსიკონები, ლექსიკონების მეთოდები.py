...
print(q)
# ყველა გასაღებს მნიშვნელობა მისცა "numbers"
q = dict.fromkeys([1, 2, 3], "numbers")
...
print(d)
# თუ არცერთია შეიყვანს და მიამატებს, არ იმუშავა რადგან ძველი "norway" დაინახა
d.setdefault("Norway", "Oslo")
print(d)
